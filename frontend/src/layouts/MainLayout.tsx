...
export function MainLayout({ role }: { role?: UserRole }) {
  ...
  return (
    /* ✅ root ล็อกความสูง + ไม่ให้ body scroll */
    <div className="h-[100dvh] bg-slate-100 overflow-hidden">
      {/* ===== TOP BAR (MOBILE) ===== */}
      <div className="sticky top-0 z-40 flex h-14 items-center justify-between border-b bg-slate-900 px-3 text-slate-100 md:hidden">
        <button
      ...
      {/* ===== BODY ===== */}
      <div className="flex h-[calc(100dvh-56px)] md:h-[100dvh]">
        {/* ===== SIDEBAR (DESKTOP) ===== */}
        <aside className="hidden w-64 flex-col bg-slate-900 text-slate-100 md:flex md:h-full md:overflow-y-auto">
        ...
        {open && (
          <div className="fixed inset-0 z-50 md:hidden">
            ...
            />
            <div className="absolute left-0 top-0 h-full w-72 bg-slate-900 p-3 text-slate-100 shadow-xl overflow-y-auto">
